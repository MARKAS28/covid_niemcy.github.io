(L.Control.TimeLineSlider = L.Control.extend({
  ...
  initialize: function (options) {
    "function" != typeof options.changeMap &&
      (options.changeMap = function ({ label: label, value: value, map: map }) {
        console.log(
          "You are not using the value or label from the timeline to change the map."
        );
      }),
      parseFloat(options.thumbHeight) <= 2 &&
        console.log(
  ...
  onAdd: function (map) {
    ...
    (this.thumbSize = 2 * parseFloat(this.options.thumbHeight)),
    (this.activeThumbSize = 2 * this.thumbSize),
    (this.rangeWidthCSS =
    ...
    (this.coverBackgroundRGBA = this.hexToRGBA(
      this.options.backgroundColor,
      0
    )),
    (that = this),
  ...
  hexToRGBA: function (hex, opacity) {
    ...
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(hex))
      return (
        ...
        "rgba(" +
          [((c = "0x" + c.join("")) >> 16) & 255, (c >> 8) & 255, 255 & c].join(
            ","
          ) +
          "," +
          opacity +
  ...
  setupStartStyles: function () {
    return (
      (style = `\n            .control_container { \n                background-color: ${
      ...
      } ${that.options.bottomBgPadding} ${
        that.options.leftBgPadding
      };\n            }\n\n            .range {\n                position: relative;\n                left: -${
        that.thumbSize
      }px;\n                height: 5px;\n                width: ${
        that.rangeWidthCSS
        ...
        that.options.labelWidth
      };\n                font-size: ${
        that.options.labelFontSize
        ...
        that.options.betweenLabelAndRangeSpace
      };\n                right: 0;\n                left: 0;\n                content: "";\n                margin: 0 auto;\n                border-radius: 50%;\n            }\n            .range-labels .active {\n                color: ${
        that.options.activeColor
  ...
  getTrackStyle: function (el, sliderLength) {
    ...
    for (li of ((style = ""), that.rangeLabelArray))
