...
info.update = function (props) {
    this._div.innerHTML = '<h4>Dane na temat pandemii COVID-19<br/> w Niemczech</h4>'+'Szpitale'+'<br/>'+ (props ?
        '<b>' + props.NAME_1 + '</b><br />' + props.szpitale + ' współczynnik na 100 000 mieszkańców'
...
function style(feature) {
  return {
      fillColor: getColor(feature.properties.szpitale), 
      weight: 2,
      opacity: 1,
      color: 'gray',
      fillOpacity: 1,
...
// console.log(landsData3)
L.geoJson(landsData3, {style: style}).addTo(map);
